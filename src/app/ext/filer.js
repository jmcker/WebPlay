...
var Filer = new function() {
         ...
         *     to this method.
         * @param {...string} paths 1-2 paths to lookup and return entries for.
        ...
        var getEntry_ = function(callback, paths, opt_errorHandler) {
            ...
            var onError = function(e) {
                ...
                if (e.name === "NotFoundError") {
                    if (destStr) {
                        error = srcStr + " or " + destStr + " does not exist.";
                    } else {
                        error = srcStr + " does not exist.";
                    }
                } else {
         ...
         * @param {Function} failCallback Function to be called if file does not exist
         */
        Filer.prototype.exists = function(entryOrPath, successCallback, failCallback) {
            if (!fs_) {
                throw new Error(FS_INIT_ERROR_MSG);
            }
            ...
            if (entryOrPath.isFile || entryOrPath.isDirectory) {
                ...
                getEntry_(function(fileEntry) {
                    successCallback();
                }, [pathToFsURL_(entryOrPath)], failCallback);
            }
        }
